An Eye Movement Controlled Mouse using Arduino and inbuilt Java libraries.

Steps: 

1)  Solder the IR as per the image uploaded and make the connection accoding to as shown in the document.
